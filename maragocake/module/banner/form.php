...
<form action="<?php echo BASE_URL."module/banner/action.php?banner_id=$banner_id"?>" method="post" enctype="multipart/form-data">
	...
	<div class="element-form">
		<label>Banner</label>	
		<span><input type="text" name="banner" placeholder="Masukan Banner" required="required" data-validation-required-message=" Masukan Banner" value="<?php echo $banner; ?>" /></span>
	</div>	

	<div class="element-form">
		<label>Link</label>	
		<span><input type="text" name="link" placeholder="Masukan Link produk" required="required" data-validation-required-message=" Masukan Link produk" value="<?php echo $link; ?>" /></span>
	</div>	   
