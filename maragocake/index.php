...
<html>
	...
	<head>
		<title>maragocake | kue terenak sebogor</title>
		<link href="<?php echo BASE_URL."images/navicon.png"; ?>" rel="shortcut icon" />
					...
					<div id="user">
						<?php
							if($user_id){
								...
								echo "<a href='".BASE_URL."index.php'>| Beranda | </a>
